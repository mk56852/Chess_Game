...
public class FenetreJeu extends JFrame implements  MouseListener{
	...
	public FenetreJeu (String num1 ,String num2) throws IOException
	{
		...
		/****************Corp du Jeu ********************/
		JLabel  jl = new JLabel(new ImageIcon(ImageIO.read(new File("images/10.jpg")))) ;
		JLabel  jlx = new JLabel(new ImageIcon(ImageIO.read(new File("images/mk.png")))) ;
		...
		JLabel jl3 =new JLabel(new ImageIcon(ImageIO.read(new File("images/cg.png")))) ;
		JLabel jl4 =new JLabel(new ImageIcon(ImageIO.read(new File("images/cg.png")))) ;
	    ...
	    JLabel labelchrono1 = new JLabel(new ImageIcon(ImageIO.read(new File("images/egg2.png")))) ;
	   jl.add(labelchrono1) ;
	   ...
	   JLabel labelchrono2 = new JLabel(new ImageIcon(ImageIO.read(new File("images/egg2.png")))) ;
	   jl.add(labelchrono2) ;
	   ...
	   JLabel labelchrono3 = new JLabel(new ImageIcon(ImageIO.read(new File("images/egg2.png")))) ;
	    jl.add(labelchrono3) ;
	...
	//les deux demi cercle jl5 et jl6	
	 jl5 = new JLabel(new ImageIcon(ImageIO.read(new File("images/ek.png")))) ;
	 jl.add(jl5) ;
	 jl5.setBounds(1050,110,150,280);
	 jl5.addMouseListener(this);
		
	 jl6 = new JLabel(new ImageIcon(ImageIO.read(new File("images/ek.png")))) ;
	 jl.add(jl6) ;
	 ...
	 /********************/
	 labelPiece1 = new JLabel(new ImageIcon(ImageIO.read(new File("images/j1.png")))) ;  ; PieceGagne1= new JLabel() ;jl.add(labelPiece1); labelPiece1.add( PieceGagne1)  ; labelPiece1.setBounds(1070,80,330,330);labelPiece1.setLayout(null);
	 PieceGagne1.setBounds(50,38,270,270);  PieceGagne1.setLayout(new GridLayout(4,4)) ; PieceGagne1.setBackground(new Color(235,235,235,64)); 
		...
		PieceGagne1.addMouseListener(this);
		 ...
		 labelPiece2 = new JLabel(new ImageIcon(ImageIO.read(new File("images/j1.png")))) ;  ;  PieceGagne2= new JLabel() ; jl.add(labelPiece2); labelPiece2.add( PieceGagne2); labelPiece2.setBounds(1070,440,330,330);labelPiece2.setLayout(null);
		...
		fin = new JLabel(new ImageIcon(ImageIO.read(new File("images/exit.png")))) ; 

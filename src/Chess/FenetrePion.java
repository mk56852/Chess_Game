...
public class FenetrePion extends JFrame implements ActionListener {
	...
	public FenetrePion(Case c)throws IOException 
	{
		...
		PionCase = c ;
		p = new JLabel(new ImageIcon(ImageIO.read(new File("images/chess2.jpg")))) ;
		this.add(p) ;
		...
		{	b1.setIcon(Echiquier.ImageResize("icon/t"+Echiquier.num1+".png"));
			b2.setIcon(Echiquier.ImageResize(("icon/c"+Echiquier.num1+".png")));
			b3.setIcon(Echiquier.ImageResize(("icon/f"+Echiquier.num1+".png")));
			b4.setIcon(Echiquier.ImageResize(("icon/r"+Echiquier.num1+".png")));
		}
		else
		{	b1.setIcon(Echiquier.ImageResize("icon/t"+Echiquier.num2+".png"));
			b2.setIcon(Echiquier.ImageResize(("icon/c"+Echiquier.num2+".png")));
			b3.setIcon(Echiquier.ImageResize(("icon/f"+Echiquier.num2+".png")));
			b4.setIcon(Echiquier.ImageResize(("icon/r"+Echiquier.num2+".png")));
		}
